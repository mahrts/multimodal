...
from loadenv.env import get_default_model_choice, USER_API_KEY
from UTILS.utils import detect_file_type
from types_moderation.moderation_result import (
...
def main():
    ...
    uvicorn.run("APP.fastapi_app:app", host="0.0.0.0", port=8000, reload=True, log_level="trace")
