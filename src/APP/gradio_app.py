...
from loadenv.env import USER_API_KEY, API_BASE_URL
from UTILS.tracing import setup_tracing, get_tracer, add_media_to_span
...
def check_content_safety(*, text: str | None = None, media: str | None = None) -> Tuple[bool, str, str]:
    ...
    """
    with tracer.start_as_current_span(name="moderate_text") as span:
...
class ChatSessionWithTracing:
    ...
    async def chat_with_gemini(self, message: dict, history: List, past_messages: List) -> Tuple[str, List, str]:
        ...
        with tracer.start_as_current_span( "chat_turn",
                    ...
                    attributes={"session.id": self.session_id}) as span:
                ...
                # MODERATION STEP 2: Check media files
                    ...
                    for file_path in value:
                        ...
                        try:
                            ...
                            binary_content = BinaryContent(data=file_bytes,
                                                            media_type=mime_type)
                            prompt_parts.append(binary_content)
