"""Instruction and functions for image content moderations."""

from pydantic_ai import Agent
from pydantic_ai.messages import BinaryContent
from types_moderation.model_choice import ModelChoice
from types_moderation.moderation_result import ImageModerationResult
...
async def moderate_image(model_choice: ModelChoice, image_source: bytes,
                            media_type: str
                        ) -> ImageModerationResult:
    """Retrieve output for image moderation."""
    ...
    result = await image_moderation_agent.run(
        [
            "Please moderate this image according to the instructions.",
            image_input,
        ],
