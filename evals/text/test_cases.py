...
from COMMON_EVAL.common_evaluators import HasRationale
from COMMON_EVAL.config import get_model_under_test, get_judge_model
from COMMON_EVAL.utils import create_repeated_cases, get_test_data_path
...
from loadenv.env import EVAL_NUM_REPEATS
text_dataset = Dataset[List[TextInput], TextModerationResult, Any](\
    cases=create_repeated_cases(base_cases=cases, num_repeats=EVAL_NUM_REPEATS),
    evaluators=[
...
async def main():
    ...
    report = await text_dataset.evaluate(task=run_text_moderation,
